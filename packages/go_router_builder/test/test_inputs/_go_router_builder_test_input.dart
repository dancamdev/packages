...
@ShouldGenerate(r'''
RouteBase get $extraRequiredValueRoute => GoRouteData.$route(
      path: '/default-value-route',
      factory: $ExtraRequiredValueRouteExtension._fromState,
    );

extension $ExtraRequiredValueRouteExtension on ExtraRequiredValueRoute {
  static ExtraRequiredValueRoute _fromState(GoRouterState state) =>
      ExtraRequiredValueRoute(
        $extra: state.extra as int,
      );
...
''')
@TypedGoRoute<ExtraRequiredValueRoute>(path: '/default-value-route')
class ExtraRequiredValueRoute extends GoRouteData {
  ExtraRequiredValueRoute({required this.$extra});
  final int $extra;
}
